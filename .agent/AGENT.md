...
| **[clean-architecture](skills/frontend-architecture-clean/SKILL.md)** | `skills/frontend-architecture-clean` |
| **[screaming-architecture](skills/frontend-architecture-screaming/SKILL.md)** | `skills/frontend-architecture-screaming` |
...
| **[component-composition](skills/frontend-react-component-composition/SKILL.md)** | `skills/frontend-react-component-composition` |
| **[custom-hooks](skills/frontend-react-hooks-custom/SKILL.md)** | `skills/frontend-react-hooks-custom` |
...
| **[tailwind](skills/frontend-ui-tailwind-standards/SKILL.md)** | `skills/frontend-ui-tailwind-standards` |
| **[design-system](skills/frontend-ui-design-system/SKILL.md)** | `skills/frontend-ui-design-system` |
...
| **[zustand](skills/frontend-state-zustand/SKILL.md)** | `skills/frontend-state-zustand` |
...
| **[api-layer](skills/frontend-data-api-layer/SKILL.md)** | `skills/frontend-data-api-layer` |
...
| **[formatting](skills/frontend-quality-formatting/SKILL.md)** | `skills/frontend-quality-formatting` |
| **[error-boundaries](skills/frontend-quality-error-boundaries/SKILL.md)** | `skills/frontend-quality-error-boundaries` |
| **[error-handling-patterns](skills/error-handling-patterns/SKILL.md)** | `skills/error-handling-patterns` |
| **[build-tools](skills/frontend-delivery-build-tools/SKILL.md)** | `skills/frontend-delivery-build-tools` |
...
| **[seo-react](skills/frontend-seo-react/SKILL.md)** | `skills/frontend-seo-react` |
...
| **[php-modern-features](skills/backend-php-modern-features/SKILL.md)** | `skills/backend-php-modern-features` |
...
| **[service-layer](skills/backend-architecture-service-layer/SKILL.md)** | `skills/backend-architecture-service-layer` |
...
| **[models](skills/backend-codeigniter-models/SKILL.md)** | `skills/backend-codeigniter-models` |
| **[routing](skills/backend-codeigniter-routing/SKILL.md)** | `skills/backend-codeigniter-routing` |
...
| **[migrations](skills/backend-database-migrations/SKILL.md)** | `skills/backend-database-migrations` |
...
| **[production-checklist](skills/backend-deployment-production-checklist/SKILL.md)** | `skills/backend-deployment-production-checklist` |
...
| :--- | :--- | :--- |
| **[Antigravity](workflows/antigravity.md)** | Standard operating procedure for Antigravity agent. | `workflows/antigravity.md` |
